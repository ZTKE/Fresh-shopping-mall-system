<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Commodity table name" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="Commodity table name" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Commodity table name" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="Commodity table name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Commodity ID" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="Commodity ID" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Commodity ID" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="Commodity ID" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Cpicture" prop="picture">
          <file-upload
          tip="Click upload picture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Cpicture" prop="picture">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Unit Price" prop="price">
          <el-input v-model="ruleForm.price" 
              placeholder="Unit Price" clearable  :readonly="ro.price"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Unit Price" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="Unit Price" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Membership price" prop="discountprice">
          <el-input v-model="ruleForm.discountprice" 
              placeholder="Membership price" clearable  :readonly="ro.discountprice"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Membership price" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
                placeholder="Membership price" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
