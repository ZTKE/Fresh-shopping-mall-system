<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Collection name" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="Collection name" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Collection name" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="Collection name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Collect pictures" prop="picture">
          <file-upload
          tip="Click upload favorite pictures"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Collect pictures" prop="picture">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Recommended type" prop="inteltype">
          <el-input v-model="ruleForm.inteltype" 
              placeholder="Recommended type" clearable  :readonly="ro.inteltype"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Recommended type" prop="inteltype">
              <el-input v-model="ruleForm.inteltype" 
                placeholder="Recommended type" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	inteltype : false,
      ...
      rules: {
          ...
          name: [
                { required: true, message: 'Collection name不能为空', trigger: 'blur' },
          ],
          picture: [
                { required: true, message: 'Collect pictures不能为空', trigger: 'blur' },
          ],
          type: [
          ],
          inteltype: [
