<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Personal account number" prop="gerenzhanghao">
          <el-input v-model="ruleForm.gerenzhanghao" 
              placeholder="Personal account number" clearable  :readonly="ro.gerenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Personal account number" prop="gerenzhanghao">
              <el-input v-model="ruleForm.gerenzhanghao" 
                placeholder="Personal account number" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="full name" prop="xingming">
          <el-input v-model="ruleForm.xingming" 
              placeholder="full name" clearable  :readonly="ro.xingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="full name" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="full name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="mailbox" prop="youxiang">
          <el-input v-model="ruleForm.youxiang" 
              placeholder="mailbox" clearable  :readonly="ro.youxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="mailbox" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="mailbox" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="phone number" prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma" 
              placeholder="phone number" clearable  :readonly="ro.shoujihaoma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="phone number" prop="shoujihaoma">
              <el-input v-model="ruleForm.shoujihaoma" 
                placeholder="phone number" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="head portrait" prop="touxiang">
          <file-upload
          tip="Click upload head portrait"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="head portrait" prop="touxiang">
  ...
  data() {
    ...
    var validateEmail = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("Please enter the correct mailbox address"));
      } else {
        callback();
      }
    };
	...
	money : false,
      ...
      rules: {
          gerenzhanghao: [
                { required: true, message: 'Personal account number cannot be empty', trigger: 'blur' },
          ],
          mima: [
