<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="Order number" prop="orderid">
            <el-input v-model="ruleForm.orderid" 
                placeholder="Order number" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.orderid" label="Order number" prop="orderid">
              <el-input v-model="ruleForm.orderid" 
                placeholder="Order number" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Trade name" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="Trade name" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Trade name" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
                placeholder="Trade name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="Product picture" prop="picture">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="Product picture" prop="picture">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Purchase quantity" prop="buynumber">
          <el-input v-model="ruleForm.buynumber" 
              placeholder="Purchase quantity" clearable  :readonly="ro.buynumber"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Purchase quantity" prop="buynumber">
              <el-input v-model="ruleForm.buynumber" 
                placeholder="Purchase quantity" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Price / points" prop="price">
          <el-input v-model="ruleForm.price" 
              placeholder="Price / points" clearable  :readonly="ro.price"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Price / points" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="Price / points" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Total price / total points" prop="total">
          <el-input v-model="ruleForm.total" 
              placeholder="Total price / total points" clearable  :readonly="ro.total"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Total price / total points" prop="total">
              <el-input v-model="ruleForm.total" 
                placeholder="Total price / total points" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="type">
          <el-select :disabled="ro.type" v-model="ruleForm.type" placeholder="Please select payment type">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Payment type" prop="type">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Telephone" prop="tel">
          <el-input v-model="ruleForm.tel" 
              placeholder="Telephone" clearable  :readonly="ro.tel"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Telephone" prop="tel">
              <el-input v-model="ruleForm.tel" 
                placeholder="Telephone" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="consignee" prop="consignee">
          <el-input v-model="ruleForm.consignee" 
              placeholder="consignee" clearable  :readonly="ro.consignee"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="consignee" prop="consignee">
              <el-input v-model="ruleForm.consignee" 
                placeholder="consignee" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <div v-if="type=='info'">
          <el-form-item class="input" label="Order time" prop="addtime">
              <el-input v-model="ruleForm.addtime"
                placeholder="Order time" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="logistics" prop="logistics">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.logistics" label="logistics" prop="logistics">
...
export default {
  data() {
    ...
    var validatePhone = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("请输入正确的Telephone号码"));
      } else {
        callback();
      }
    };
	...
	logistics : false,
      ...
      rules: {
          ...
          goodid: [
                { required: true, message: 'Commodity ID cannot be empty', trigger: 'blur' },
          ],
          goodname: [
          ],
          picture: [
          ...
          price: [
                { required: true, message: 'Price / points  cannot be empty', trigger: 'blur' },
          ...
          total: [
                { required: true, message: 'Total price / total points  cannot be empty', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          discounttotal: [
                { validator: validateNumber, trigger: 'blur' },
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../django4j60g/upload');
        } else {
