    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="brief introduction" prop="introduction">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.introduction" label="brief introduction" prop="introduction">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../django4j60g/upload');
        } else {
