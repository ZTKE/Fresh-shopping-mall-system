<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Trade name" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng" 
              placeholder="Trade name" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Trade name" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Commodity type" prop="shangpinleixing">
          <el-select :disabled="ro.shangpinleixing" v-model="ruleForm.shangpinleixing" placeholder="请选择Commodity type">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Commodity type" prop="shangpinleixing">
	      <el-input v-model="ruleForm.shangpinleixing"
                placeholder="Commodity type" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangpintupian" label="Product picture" prop="shangpintupian">
          <file-upload
          tip="Click upload Product picture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangpintupian" label="Product picture" prop="shangpintupian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Commodity specifications" prop="shangpinguige">
          <el-input v-model="ruleForm.shangpinguige" 
              placeholder="Commodity specifications" clearable  :readonly="ro.shangpinguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Commodity specifications" prop="shangpinguige">
              <el-input v-model="ruleForm.shangpinguige" 
                placeholder="Commodity specifications" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Place of production" prop="shengchandi">
          <el-input v-model="ruleForm.shengchandi" 
              placeholder="Place of production" clearable  :readonly="ro.shengchandi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Place of production" prop="shengchandi">
              <el-input v-model="ruleForm.shengchandi" 
                placeholder="Place of production" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="raw material" prop="yuancailiao">
          <el-input v-model="ruleForm.yuancailiao" 
              placeholder="raw material" clearable  :readonly="ro.yuancailiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="raw material" prop="yuancailiao">
              <el-input v-model="ruleForm.yuancailiao" 
                placeholder="raw material" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="Launch date" prop="shangjiariqi">
            <el-date-picker
                format="yyyy - MM - dd "
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangjiariqi" label="Launch date" prop="shangjiariqi">
              <el-input v-model="ruleForm.shangjiariqi" 
                placeholder="Launch date" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="Product introduction" prop="shangpinjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinjianjie" label="Product introduction" prop="shangpinjianjie">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="Product details" prop="shangpinxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinxiangqing" label="Product details" prop="shangpinxiangqing">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../django4j60g/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
