<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="consignee" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="consignee" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="consignee" prop="name">
              <el-input v-model="ruleForm.name" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="phone" prop="phone">
          <el-input v-model="ruleForm.phone" 
              placeholder="phone" clearable  :readonly="ro.phone"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="phone" prop="phone">
              <el-input v-model="ruleForm.phone" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Default address[Yes/No]" prop="isdefault">
          <el-input v-model="ruleForm.isdefault" 
              placeholder="Default address[Yes/No]" clearable  :readonly="ro.isdefault"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Default address[Yes/No]" prop="isdefault">
              <el-input v-model="ruleForm.isdefault" 
                placeholder="Default address[Yes/No]" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
    ...
    var validateIdCard = (rule, value, callback) => {
      if(!value){
        ...
        callback(new Error("Please enter the correct ID card number"));
      } else {
        callback();
      }
    };
	...
	isdefault : false,
      ...
      rules: {
          userid: [
                { required: true, message: 'The user ID cannot be empty', trigger: 'blur' },
          ],
          address: [
                { required: true, message: 'The address cannot be empty', trigger: 'blur' },
          ],
          name: [
                { required: true, message: 'The consignee cannot be empty', trigger: 'blur' },
          ],
          phone: [
                { required: true, message: 'The phone cannot be empty', trigger: 'blur' },
          ],
          isdefault: [
                { required: true, message: 'Default address[Yes/No] can not be empty', trigger: 'blur' },
          ],
      }
    };
  },
