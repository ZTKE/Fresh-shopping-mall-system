<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Commodity type" prop="shangpinleixing">
          <el-input v-model="ruleForm.shangpinleixing" 
              placeholder="Commodity type" clearable  :readonly="ro.shangpinleixing"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  data() {
	...
	shangpinleixing : false,
      ...
      rules: {
          shangpinleixing: [
                { required: true, message: 'Commodity type Cannot be empty', trigger: 'blur' },
          ],
      }
    };
  },
