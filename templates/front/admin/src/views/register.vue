<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">Online fresh market system registration</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">personal account</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gerenzhanghao" class="input" type="text" placeholder="personal account">
			   </div>
			 </div> -->
			<el-form-item label="personal account" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.gerenzhanghao" autocomplete="off" placeholder="personal account"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="confirm password" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="name" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="name"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			...
			<el-form-item label="email" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="email"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">phone</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shoujihaoma" class="input" type="text" placeholder="phone">
			   </div>
			 </div> -->
			<el-form-item label="phone" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shoujihaoma" autocomplete="off" placeholder="phone"  />
			</el-form-item>
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`yonghu` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`Email address should be in the mail format`);
        return
      }
