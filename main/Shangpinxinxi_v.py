...
def shangpinxinxi_register(request):
    if request.method in ["POST", "GET"]:
        ...
        if error != None:
            ...
            msg['msg'] = "The user already exists. Do not register again!"
...
def shangpinxinxi_info(request,id_):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if __browseClick__=="yes"  and  "clicknum"  in shangpinxinxi.getallcolumn(shangpinxinxi,shangpinxinxi):
            try:
...
def shangpinxinxi_autoSort2(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        leixing = set()
        try:
            cursor.execute("select inteltype from storeup where userid = %d"%(request.session.get("params").get("id"))+" and tablename = 'shangpinxinxi' order by addtime desc")
...
def shangpinxinxi_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/django4j60g/shangpinxinxi/notify',
            #notify_url=''
        )
...
def shangpinxinxi_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/django4j60g/admin/dist/index.html#/shangpinxinxi')
