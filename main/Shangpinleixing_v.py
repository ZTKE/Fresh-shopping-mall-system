...
def shangpinleixing_detail(request,id_):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if __browseClick__=="yes"   and  "clicknum"  in shangpinleixing.getallcolumn(shangpinleixing,shangpinleixing):
            try:
                clicknum=int(data[0].get("clicknum",0))+1
            except:
                clicknum=0+1
...
def shangpinleixing_autoSort2(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        leixing = set()
        try:
            cursor.execute("select inteltype from storeup where userid = %d"%(request.session.get("params").get("id"))+" and tablename = 'shangpinleixing' order by addtime desc")
...
def shangpinleixing_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/django4j60g/shangpinleixing/notify',
            #notify_url=''
        )
...
def shangpinleixing_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/django4j60g/admin/dist/index.html#/shangpinleixing')
