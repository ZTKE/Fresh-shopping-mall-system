...
def news_info(request,id_):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if __browseClick__=="yes"  and  "clicknum"  in news.getallcolumn(news,news):
            try:
...
def news_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/django4j60g/news/notify',
            #notify_url=''
        )
        pay_url = 'https://openapi.alipaydev.com/gateway.do?' + order_string
        pay_url = '<form name="punchout_form" method="post" action="{0}"><input type="hidden" name="biz_content" ><input type="submit" value="immediate payment" style="display: none"></form>'.format(pay_url)
...
def news_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/django4j60g/admin/dist/index.html#/news')
